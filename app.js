...
const _PDF_CSS=`
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .hdr-acct{font-size:11px;color:#1D3C2A;font-weight:700;margin-top:5px;background:#EAF5EE;display:inline-block;padding:3px 10px;border-radius:20px;border:1px solid #C8E6C9}
  ...
  .ftr-company{font-size:11px;font-weight:700;color:#1D3C2A;margin-bottom:3px}
  .ftr-acct{font-size:11px;color:#555;font-weight:600;margin-bottom:2px;background:#f5f0e8;display:inline-block;padding:3px 10px;border-radius:20px}
  .ftr-date{font-size:10px;color:#aaa;margin-top:3px}
...
function _pdfHeader(title,subtitle){
  return `<div class="hdr">
    <div class="hdr-left">
      ...
      <div class="hdr-acct">✍ محاسب: محمود مصباح &nbsp;|&nbsp; 📞 01114892670</div>
    </div>
...
function _xlAddTitle(ws,title,cols,summary){
  ...
  const a=ws.addRow(['✍ محاسب: محمود مصباح  |  📞 01114892670  |  تاريخ: '+new Date().toLocaleDateString('ar-EG')+(summary?' |  '+summary:'')]);
...
function _xlAddFooter(ws,cols){
  ...
  const f=ws.lastRow;
  f.getCell(1).value='Legacy Fine Touch  |  م. محمد شكري  |  01099808939  |  سري وخاص بالشركة';
  f.getCell(1).font={size:9,color:{argb:'FFAAAAAA'},italic:true};
