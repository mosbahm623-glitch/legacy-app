...
const _PDF_CSS=`
  *{margin:0;padding:0;box-sizing:border-box}
  body{font-family:Arial,sans-serif;direction:rtl;background:#f5f5f5;color:#1a1a1a}
  ...
  .hdr-left h1{font-size:24px;font-weight:900;color:#1D3C2A;margin-bottom:3px}
  .hdr-left .sub{font-size:12px;color:#888;line-height:1.6}
  ...
  .hdr-badge.owner{background:#EAF5EE;color:#1E6B3A;border:1px solid #C8E6C9}
  .hdr-badge.acct{background:#E3F0FF;color:#185FA5;border:1px solid #BBDEFB}
  ...
  .kpi-inc{background:#EAF5EE;border-color:#C8E6C9;color:#1E6B3A}
  .kpi-exp{background:#FFEBEE;border-color:#FFCDD2;color:#922B21}
  .kpi-adv{background:#E3F0FF;border-color:#BBDEFB;color:#185FA5}
  .kpi-net-pos{background:#EAF5EE;border-color:#C8E6C9;color:#1E6B3A}
  .kpi-net-neg{background:#FFEBEE;border-color:#FFCDD2;color:#922B21}
  .kpi-neutral{background:#f9f9f9;border-color:#e0e0e0;color:#555}
  /* ── SECTION TITLE ── */
  .sec-ttl{font-size:13px;font-weight:800;color:#1D3C2A;padding:10px 0;border-bottom:2px solid #e0e0e0;margin-bottom:0;display:flex;align-items:center;gap:6px}
  /* ── TABLE ── */
  table{width:100%;border-collapse:collapse;font-size:11px;margin-bottom:24px}
  thead tr{background:#1D3C2A}
  th{color:#E8E0D0;padding:10px 8px;text-align:right;font-size:10px;font-weight:700;letter-spacing:.3px}
  ...
  .b-i{background:#EAF5EE;color:#1E6B3A}.b-e{background:#FFEBEE;color:#922B21}
  .b-pay{background:#EAF5EE;color:#1E6B3A}.b-work{background:#E3F0FF;color:#185FA5}.b-mat{background:#FFF3E0;color:#E65100}
  /* ── AMOUNTS ── */
  ...
  .ftr-company{font-size:12px;font-weight:800;color:#1D3C2A;margin-bottom:4px}
  .ftr-owner{font-size:10px;color:#1E6B3A;font-weight:600;margin-bottom:2px}
  .ftr-acct{font-size:10px;color:#185FA5;font-weight:600;background:#E3F0FF;display:inline-block;padding:2px 10px;border-radius:20px;margin-bottom:3px}
  .ftr-date{font-size:9px;color:#aaa;margin-top:2px}
  .ftr-conf{font-size:9px;color:#ccc;text-align:left;line-height:1.5;flex-shrink:0}
