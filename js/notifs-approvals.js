...
<div class="appr-chips-bar" id="apprChipsBar">
  ${allPersonNames.length>0?`<div class="appr-chip" id="apprChipPerson" onclick="_toggleApprChip('apprDropPerson')">
  ...
  ${allProjIds.length>0?`<div class="appr-chip" id="apprChipProj" onclick="_toggleApprChip('apprDropProj')">
