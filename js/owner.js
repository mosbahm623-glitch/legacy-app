...
async function loadOwnerScreen(){
  ...
  el.innerHTML=
    ...
    // Main card
    '<div style="background:#fff;border-radius:20px 20px 0 0;flex:1;padding:16px;display:flex;flex-direction:column;gap:10px;overflow-y:auto;overflow-x:hidden;padding-bottom:100px">'+
    ...
    '</div>'+
    '<div style="position:fixed;bottom:calc(58px + env(safe-area-inset-bottom,0px));right:0;left:0;padding:8px 16px;background:#1D3C2A;z-index:200;box-shadow:0 -4px 20px rgba(0,0,0,.2)">'+
